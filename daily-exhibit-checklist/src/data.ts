...
export const EXHIBITS: ExhibitDefinition[] = [
  {
    id: 'pop',
    name: 'Power Of Place (POP)',
    shortName: 'POP',
    description: 'Audio, projector, and lighting readiness log for the Power Of Place exhibit.',
    accent: '#5ce1e6',
    fields: [
      { id: 'date', label: 'Date', type: 'date' },
      { id: 'audioCheck', label: 'Audio Check', type: 'check' },
      { id: 'projectorCheck', label: 'Projector Check', type: 'check' },
      { id: 'lighting', label: 'Lighting', type: 'check' },
  ...
  },
  {
    ...
    description: 'Full media, projector, and headphone walkthrough for Wellspring.',
    accent: '#f6bd60',
    fields: [
      { id: 'date', label: 'Date', type: 'date' },
      { id: 'audioCheck', label: 'Audio Check', type: 'check' },
      { id: 'videoCheck', label: 'Video Check', type: 'check' },
      { id: 'headphoneCheck', label: 'Headphone Check', type: 'check' },
      { id: 'projectorCheck', label: 'Projector Check', type: 'check' },
      { id: 'lighting', label: 'Lighting', type: 'check' },
      { id: 'notes', label: 'Notes / Issues Found', type: 'notes' },
      { id: 'checkedBy', label: 'Checked By', type: 'text' },
  ...
  },
  {
    ...
    name: 'Torn',
    shortName: 'Torn',
    description: 'Operational, audio, and video log for the Torn exhibit.',
    accent: '#ef476f',
    fields: [
      { id: 'date', label: 'Date', type: 'date' },
      { id: 'powerOperational', label: 'Power / Operational', type: 'check' },
      { id: 'audioCheck', label: 'Audio Check', type: 'check' },
      { id: 'videoCheck', label: 'Video Check', type: 'check' },
      { id: 'notes', label: 'Notes / Issues Found', type: 'notes' },
      { id: 'checkedBy', label: 'Checked By', type: 'text' },
