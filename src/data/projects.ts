...
export const PROJECTS: Project[] = [
  ...
  // },
  {
    ...
    href: 'https://projects.vantaproject.org',
    status: 'Live',
    category: 'Web',
  },
  {
  ...
  },
  {
    ...
    href: 'https://rl.vantaproject.org',
    status: 'Beta',
    category: 'Web',
  },
  {
    title: 'Log Analyzer',
    blurb: 'Coming Soon – A web application that analyzes and visualizes log data, providing insights and trends for better decision-making.',
  ...
  },
  {
    ...
    blurb: 'A browser-based utility used to centralize settings across various platforms, providing a unified interface for locating preferences and settings.',
    tags: ['TypeScript', 'UI'],
    href: 'https://settings.vantaproject.org',
    status: 'Concept',
    category: 'Web',
  },
  {
