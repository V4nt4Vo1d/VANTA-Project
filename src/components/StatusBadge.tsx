export function StatusBadge({ status }: { status: ProjectStatus }) {
  const classes = (() => {
    switch (status) {
      ...
      case 'Coming Soon': return 'border-zinc-400/40 text-zinc-300 bg-zinc-400/10'
...
export type ProjectStatus = 'Idea' | 'WIP' | 'Alpha' | 'Beta' | 'Prototype' | 'Shipped' | 'Concept' | 'Live' | 'Coming Soon'